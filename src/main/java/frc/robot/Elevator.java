...
class Elevator {
  ...
  private double elevatorHighLimit = 6.0; // The high limit of the elevator motor in meters.
  private double elevatorLowLimit = 0.0; // The high limit of the elevator motor in meters.

  public Elevator() {
    configMotor(elevatorMotor1, false, 80.0); // Configures the motor with counterclockwise rotation positive and 80A current limit.
    configMotor(elevatorMotor2, true, 80.0); // Configures the motor with counterclockwise rotation positive and 80A current limit.
